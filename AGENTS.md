...
This project is indexed by GitNexus as **AI-Agent-App** (109 symbols, 162 relationships, 6 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
