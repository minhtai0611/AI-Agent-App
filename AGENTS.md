...
This project is indexed by GitNexus as **AI-Agent-App** (4959 symbols, 14553 relationships, 273 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
