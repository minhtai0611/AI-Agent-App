...
This project is indexed by GitNexus as **AI-Agent-App** (4486 symbols, 12357 relationships, 249 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
