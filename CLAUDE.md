...
This project is indexed by GitNexus as **AI-Agent-App** (4468 symbols, 12311 relationships, 244 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
