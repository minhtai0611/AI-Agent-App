...
This project is indexed by GitNexus as **AI-Agent-App** (4474 symbols, 12321 relationships, 244 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
