      ...
      >
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              maxLength={200}
              className="w-full px-4 py-3 rounded-xl border border-surface bg-surface font-jakarta text-[13px] text-foreground placeholder-[#475569] focus:outline-none focus:border-primary transition"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-surface bg-surface font-jakarta text-[13px] text-foreground focus:outline-none focus:border-primary transition"
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={saving}
            className="flex-1 py-2.5 rounded-xl border border-surface font-jakarta text-[13px] text-dim hover:text-muted hover:border-primary/30 transition"
          >
            Bỏ qua
          </button>
          <button
            ...
            disabled={saving}
            className="flex-1 py-2.5 rounded-xl font-jakarta text-[13px] font-bold text-background transition disabled:opacity-60"
