    ...
    <div className={`font-sans text-[0.8125rem] text-muted leading-relaxed prose-dark ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          h1: ({ children }) => <h1 className="font-sans font-bold text-[15px] font-semibold text-highlight mb-1 mt-3 first:mt-0">{children}</h1>,
          h2: ({ children }) => <h2 className="font-sans font-bold text-sm font-semibold text-highlight mb-1 mt-3 first:mt-0">{children}</h2>,
          h3: ({ children }) => <h3 className="font-sans text-[0.8125rem] font-semibold text-highlight mb-1 mt-2 first:mt-0">{children}</h3>,
