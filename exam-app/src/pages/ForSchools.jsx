...
export default function ForSchools() {
  usePageMeta('Vantage cho Trường học', { description: 'Giải pháp ôn thi THPT AI cho trường học và trung tâm luyện thi tại Việt Nam.' })
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="min-h-screen bg-background">
      ...
      <nav className="flex items-center justify-between px-8 py-4 border-b border-border bg-surface">
        ...
        <span className="font-sans text-[14px] font-semibold text-foreground">Vantage cho Trường học</span>
      ...
      <div className="max-w-3xl mx-auto px-6 py-16 flex flex-col gap-16">
        ...
        <div className="flex flex-col gap-5 text-center">
          ...
          <p className="font-sans text-[15px] text-muted max-w-xl mx-auto leading-relaxed">
            Vantage phân tích điểm yếu của từng học sinh, tự động lên lịch ôn tập, và báo cáo tiến độ cả lớp — để giáo viên tập trung vào giảng dạy thay vì chấm điểm thủ công.
          </p>
